    ...
    extend: {
      ...
      colors: {
        ...
        christmas: {
          ...
          "green-glow": "hsl(var(--christmas-green-glow))",
      ...
      backgroundImage: {
        ...
        "christmas-gradient": "linear-gradient(135deg, hsl(var(--christmas-red)) 0%, hsl(var(--christmas-gold)) 50%, hsl(var(--christmas-green)) 100%)",
